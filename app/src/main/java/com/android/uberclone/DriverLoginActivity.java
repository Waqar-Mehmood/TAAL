...
//                    addUserDetails(user);
    ...
    private void addUserDetails(final FirebaseUser user) {
        ...
        mDatabaseReference.child(FirebaseConstants.USERS).child(FirebaseConstants.DRIVERS).child(user_id).setValue(true);
        ...
        done_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(phoneNumber)) {
                    ...
                    mDatabaseReference.child(FirebaseConstants.USERS).child(FirebaseConstants.DRIVERS).child(user_id)
